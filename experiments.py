...
class Experiment(object):
    def __init__(self, cameras=None, daq=None, save_mode=NP, mask_names=('WHEEL','EYE'), monitor_cam_idx=0, motion_mask='WHEEL', movement_query_frames=20, movement_std_thresh=1.5, trigger=None, inter_trial_min=5.0, feedback=False):
        """
        Parameters:
        ...
        self.monitor_img_sets = [None for i,cam in enumerate(self.cameras)]
    ...
    def new_run(self, new_masks=False,trials=None):         
        ...
        self.img_sets = [None for cam_idx in range(len(self.cameras))]
        ...
        while True:
            ...
            if not self.TRIAL_ON:           
                ...
                if self.query_for_trigger():
                    self.monitor_img_sets[self.monitor_cam_idx] = None
                    self.send_trigger()
